const CONTENT = {
  label: "03 / WHY IGDISCO",
  title: "You focus on life.",
  titleHighlight: "your systems.",
  description: "Peace of mind starts with a connected approach to IT. We work alongside your team to understand the challenges, make the right calls, and build something that lasts.",
  visionLabel: "OUR VISION",
  visionText: "Everyone can party all night without worrying about infrastructure and security — it stays up, 24/7.",
  missionLabel: "OUR MISSION",
  missionText: "Bringing cloud computing and security solutions to the world, and serving as a trusted source of infrastructure technology.",
  linkText: "Meet your engineering partners",
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-6 space-y-8">
          ...
          <div className="space-y-4 pt-2">
            <div className="border-l-4 border-brand-sky bg-sky-50/70 dark:bg-sky-950/30 p-4 rounded-r-xl space-y-1">
              <span className="text-[11px] font-mono font-bold uppercase text-brand-sky tracking-wider">{CONTENT.visionLabel}</span>
              <p className="text-sm font-medium text-slate-800 dark:text-slate-200 leading-relaxed">
                {CONTENT.visionText}
              </p>
            </div>
            <div className="border-l-4 border-brand-blue bg-blue-50/70 dark:bg-blue-950/30 p-4 rounded-r-xl space-y-1">
              <span className="text-[11px] font-mono font-bold uppercase text-brand-blue tracking-wider">{CONTENT.missionLabel}</span>
        ...
        <div className="lg:col-span-6 space-y-4 flex flex-col justify-center">
          {/* 01 */}
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md hover:border-brand-sky/50 flex items-start gap-5 transition-all">
            <div className="w-10 h-10 rounded-xl bg-sky-50 dark:bg-sky-950/40 border border-sky-100 dark:border-sky-900 flex items-center justify-center text-brand-sky shrink-0">
          ...
          {/* 02 */}
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs hover:shadow-md hover:border-disco-purple/50 flex items-start gap-5 transition-all">
            <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-950/40 border border-purple-100 dark:border-purple-900 flex items-center justify-center text-disco-purple shrink-0">
