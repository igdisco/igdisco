    ...
    <>
      <header className="border-b border-slate-200/80 dark:border-slate-800 bg-white/85 dark:bg-slate-900/85 backdrop-blur-md fixed top-0 left-0 w-full z-50 transition-all duration-300 shadow-xs px-6 lg:px-16">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <ThemeToggle />
          <Link
            className="glow-btn hidden lg:inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-[#0c51a3] via-[#008cb8] to-[#662D91] px-4 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-headline font-bold text-white shadow-md shadow-blue-900/15 transition-all hover:brightness-105 hover:shadow-lg"
            href="/consultation"
          >
        ...
        {open && (
          <div className="lg:hidden absolute top-full left-0 right-0 bg-white/95 dark:bg-slate-900/95 border-b border-slate-200 dark:border-slate-800 p-6 flex flex-col shadow-xl backdrop-blur-xl z-50 overflow-y-auto max-h-[calc(100vh-65px)]">
            ...
            <div className="py-4 pt-6 mt-2 border-t border-slate-100 dark:border-slate-800/60">
              <Link
                className="glow-btn flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#0c51a3] via-[#008cb8] to-[#662D91] px-5 py-3.5 text-sm font-headline font-bold text-white shadow-md shadow-blue-900/15 transition-all hover:brightness-105 hover:shadow-lg w-full"
                href="/consultation"
                onClick={() => setOpen(false)}
              >
                <span className="material-symbols-outlined text-lg shrink-0">rocket_launch</span>
                <span className="flex flex-col text-left leading-tight">
                  <span className="text-[10px] font-normal tracking-wide text-white/90 uppercase">Free Assessment</span>
                  <span className="text-xs font-bold text-white whitespace-nowrap">Initiate a free Audit</span>
                </span>
              </Link>
            </div>
          </div>
      ...
      <div className="h-[65px] lg:h-[71px] w-full shrink-0" aria-hidden="true" />
    </>
  );
}
